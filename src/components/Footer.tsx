        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              ...
              <li>
                <Link to="/#certifications" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Certifications
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/our-people" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Our People
                </Link>
              </li>
              <li>
