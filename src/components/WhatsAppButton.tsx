  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-30 animation-delay-500" />
        
        {/* Button */}
        <div className="relative w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-xl shadow-[#25D366]/40 transition-all duration-300 group-hover:scale-110 group-hover:shadow-[#25D366]/60 border-2 border-white">
          {/* WhatsApp SVG Icon */}
          <svg 
